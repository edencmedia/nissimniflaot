          ...
          <div className="space-y-8 animate-fade-in-up">
            <div>
              ...
              <div className="space-y-6">
                <a
                  href="tel:0535451234"
                  className="flex items-center gap-4 p-6 bg-card rounded-lg border border-border hover:border-accent transition-all duration-300 group"
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-accent/10 text-accent group-hover:bg-accent group-hover:text-accent-foreground flex items-center justify-center transition-all">
                    <Phone className="h-6 w-6" />
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">טלפון</p>
                    <p className="text-lg font-semibold text-foreground" dir="ltr">053-545-1234</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-foreground">nissanswisa11@gmail.com</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-foreground">שלח הודעה</p>
                  </div>
                </a>
              </div>
            </div>
